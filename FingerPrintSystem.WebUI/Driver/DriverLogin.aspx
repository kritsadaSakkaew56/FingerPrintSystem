<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DriverLogin.aspx.cs" Inherits="FingerPrintSystem.WebUI.Driver.DriverLogin" %>
...
<body>
    <div class="container">
        ...
        <form id="form1" runat="server" class="form-signin">
            ...
            <asp:Button ID="bthexit" runat="server" class="btn btn-lg btn-login btn-block" OnClick="bthexit_Click" Text="Exit"/>
